...
if ($k14_info['content'] && $_COOKIE['no_pic'] != "1") {
    ...
    $pic_arr = explode(",", (($use_type == "desktop" || !$k14_info['url_name']) ? $k14_info['content'] : $k14_info['url_name']));
            ...
            高度不限 -->
                <div class="img">
                    ...
                    ?>
                        ...
                        <!-- 改成手機板路徑 -->
                        <span class="mo"><img src="login_admin/upload_file/<?= $pic_info['file_path'] ?>" alt=""></span>
