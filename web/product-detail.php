...
*/
    ...
    for ($i = 0; $i < count($gift_info); $i++) {
        ...
        foreach ($gift_arr as $gift_id) {
            ...
            $all_cnt_gift_info[] = array("Fmain_id" => $j4_info['Fmain_id'], "x100_cnt_id" => $cnt_id, "product_name" => $j4_info['text_field_0'], "product_pic" => $j4_info['pic_field_1'], "give_num" => $j4_info['text_field_2'], "add_money" => $j4_info['text_field_3'], "content" => $j4_info['textarea_field_4']);
        }
    }
            ...
            <form name="buy_form" id="formId" target="" method="post" action="cart.php">
                <div class="fixedBuy">
                    <div class="fixedLeft">
                        ...
                        <div class="txt">
                            <div class="fixedTitle"><i><?= $info['text_field_0'] ?></i><span><?= $all_size_info[0]['size_name'] . $salt_out_str ?></span></div>
                            <div class="price">
...
*/
                                    ...
                                    ?>
                                        <li>
                                            ...
                                            ?>
                                                <input type="radio" name="give_id" id="hasRadio<?= ($iii + 1) ?>" value="<?= $all_cnt_gift_info[$iii]['Fmain_id'] ?>">
                                            <?
                                            } else {
                                            ?>
                                            ...
                                            <a href="javascript:$('.popupProduct').hide();$('#popupProduct<?= $all_cnt_gift_info[$iii]['Fmain_id'] ?>').show();">
                            ...
                            ?>
                                <div class="specification">
                                    ...
                                    <ul>
                                        ...
                                        ?>
                                            <li>
                                                <input type="radio" name="p_size_id" id="specification<?= ($iii + 1) ?>" value="<?= $all_size_info[$iii]['Fmain_id'] ?>" onclick="select_size('<?= $all_size_info[$iii]['Fmain_id'] ?>');">
                                                <label for="specification<?= ($iii + 1) ?>"><?= $all_size_info[$iii]['size_name'] . $salt_out_str ?></label>
                                            </li>
                                        <? } ?>
