                ...
                <div class="yearsBox">
                    <div class="swiper-container gallery-thumbs">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide" data-slide="2"><span>2022</span></div>
                            <div class="swiper-slide" data-slide="3"><span>2021</span></div>
                            <div class="swiper-slide" data-slide="4"><span>2020</span></div>
                            <div class="swiper-slide" data-slide="5"><span>2019</span></div>
                            <div class="swiper-slide" data-slide="6"><span>2018</span></div>
                            <div class="swiper-slide" data-slide="7"><span>2017</span></div>
                            <div class="swiper-slide" data-slide="8"><span>2016</span></div>
                        </div>
                    </div>
                </div>
                <!-- 圖片 840 * 472 -->
                            ...
                            <ul class="content">
                                <li class="active">
                                    ...
                                    <div class="img" style="background: url('https://picsum.photos/id/1/840/475') center / contain no-repeat">
                                        <div class="video" id="player1" data-video="AN6KR6EIgAY"></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="txt">
                                    ...
                                    <div class="img" style="background: url('https://picsum.photos/id/2/840/475') center / contain no-repeat">
                                        <div class="video" id="player2" data-video="Ek6ZIPS6LXo"></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="txt">
                                    ...
                                    <div class="img" style="background: url('https://picsum.photos/id/3/840/475') center / contain no-repeat">
                                        <div class="video" id="player3" data-video="Ek6ZIPS6LXo"></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="txt">
                                    ...
                                    <div class="img" style="background: url('https://picsum.photos/id/4/840/475') center / contain no-repeat">
                                        <div class="video" id="player4" data-video="pJm5WH2awCI"></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="txt">
                                    ...
                                    <div class="img" style="background: url('https://picsum.photos/id/5/840/475') center / contain no-repeat">
                                        <div class="video" id="player5" data-video="wNLf1mF-2iw"></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="txt">
                                    ...
                                    <div class="img" style="background: url('https://picsum.photos/id/6/840/475') center / contain no-repeat">
                                        <div class="video" id="player6" data-video="gkDn91RM3x4"></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="txt">
