                ...
                <div class="container">
                    ...
                    <div class="buyRight">
                        <div class="specification">
                            ...
                            <ul>
                                <li>
                                    <input type="radio" name="specification" id="specification1">
                                    <label for="specification1">迷霧黑</label>
                                </li>
                                <li>
                        ...
                        <div class="numBox">
                            <div>數量</div>
                            <div class="num">
                                <a href="javascript:;" class="minus hidden"></a>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="javascript:;">
                                        ...
                                        <div class="img">
                                            <div class="svg">
                                                <svg viewBox="0 0 376 414" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M6 0.5H370C373.038 0.5 375.5 2.96244 375.5 6V408C375.5 411.038 373.038 413.5 370 413.5H6.00001C2.96244 413.5 0.5 411.038 0.5 408V6C0.5 2.96243 2.96243 0.5 6 0.5Z" />
                                                </svg>
                                            </div>
                                            <!-- 376 * 414 -->

                                            <!-- 預設顯示第一張圖 -->
                                            <img src="dist/images/productPage/product_max_1.jpg" alt=""
                                                class="defaultImg">
                                            <!-- hover後顯示的照片 -->
